...
function Principal() {
  ...
  return (
    <div className='w-full min-h-screen flex flex-col items-center'>
      ...
      <div className='w-[90%] border border-black flex flex-row-reverse flex-wrap  justify-center items-center gap-10 mt-10 mb-20'>
        ...
        <div className='TEXTO flex flex-col items-start gap-4'>
          ...
          <a href="http://" target="_blank" rel="noopener noreferrer" className='p-3 bg-[#FF006E] shadow-sm rounded-full text-gray-100 font-bold'>Hablá con un experto</a>
        </div>
